            ...
            <MDBRow>
              ...
              <MDBCol lg="2" md="6" className="align-self-start px-md-5" style={{ fontWeight: "bold", fontSize: "15px" }}>
                ...
                <ul className="list-unstyled">
                  ...
                  <li>
                    <a href="https://blog.satriaana.org/" className="text-dark">
                      Blog
                    </a>
                  </li>
                  <li>
                    <a href="https://forum.satriaana.org/" className="text-dark">
                      Forum
                    </a>
                  </li>
                  <li>
            ...
            <MDBRow>
              ...
              <MDBCol lg="3">
                <a
                  ...
                  href="https://www.facebook.com/satriaanaorg"
                  role="button"
                >
                ...
                <a
                  style={{ color: 'black', marginRight: '0.8em' }}
                  href="https://twitter.com/satriaanaorg"
                  role="button"
                >
                ...
                <a
                  style={{ color: 'black', marginRight: '0.8em' }}
                  href="https://www.instagram.com/satriaanaorg"
                  role="button"
                >
                ...
                <a
                  style={{ color: 'black', marginRight: '0.8em' }}
                  href="https://www.linkedin.com/in/satriaanaorg"
                  role="button"
                >
                ...
                <a
                  style={{ color: 'black', marginRight: '0.8em' }}
                  href="https://github.com/Satriaana"
                  role="button"
                >
                ...
                <a
                  style={{ color: 'black' }}
                  href="https://www.reddit.com/r/Satriaana/"
                  role="button"
                >
